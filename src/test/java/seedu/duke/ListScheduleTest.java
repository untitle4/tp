...
class ListScheduleTest {
    ...
    void getAllEventsPrinted_emptySchedule_expectException() throws EmptyListException {
        ListSchedule listSchedule = new ListSchedule(new ArrayList<>(), new ArrayList<>(), new ArrayList<>(), new ArrayList<>());
    ...
    void getAllEventsPrinted_classSchedule_classList() throws EmptyListException {
        ...
        ListSchedule listSchedule = new ListSchedule(classes, new ArrayList<>(), new ArrayList<>(), new ArrayList<>());
