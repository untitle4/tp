...
public interface Interactable {
    void add(String userInput) throws ContactEmptyStringException, ContactParamException,
            QuizParamException, MissingParameterException, EmptyParameterException;
